        ...
        <div className={content.content_main}>
            <div className={`${content.content_section}`}>
                <div className={styles.about_section}>
                    ...
                    <p className={styles.wid}> The UCSD Biosensor Core, inspired by Roger Tsien’s pioneering work, provides support for the use and development of genetically encoded biosensors, including fluorescent and bioluminescent indicators and optogenetic tools. We are an integral component of the DRC Biological Imaging Core, supported by the UCSD/UCLA NIDDK Diabetes Research Center (P30 DK063491).</p>
                </div>
            </div>
